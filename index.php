    ...
    <body>
        ...
        <div class="container">
                ...
                <tbody>
                    <?php foreach ($monsters as $monster) { ?>
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-danger" href="deletemonster.php?id=<?php echo $monster->getId(); ?>">Supprimer</a>
                                <a class="btn btn-secondary" href="editmonster.php?id=<?php echo $monster->getId(); ?>">Modifier</a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
            ...
            <div class="text-center">
                <a class="btn btn-primary" href="addmonster.php" ="submit">Ajouter un Monstre</a>
            </div>
